    ...
    >
      <div className="w-11/12 pe-4 lg:w-9/12 flex flex-col gap-2 pt-10 ps-4 lg:ps-10">
        ...
        >
          ...
          <div
            className="w-full flex flex-row gap-3 mt-4"
            style={{
              // paddingLeft: 10,
              overflowX: "auto",
              whiteSpace: "nowrap",
                  ...
                  >
                    {cardsListData.map((item) => (
                      <div className="flex flex-row gap-4" key={item.id}>
                        <div
                          className="flex flex-col justify-between p-5 lg:w-[300px] lg:h-[150px]"
          ...
          >
            ...
            <div
              className="w-full flex flex-row justify-between mt-5 gap-2 lg:flex hidden"
              style={{
                backgroundColor: "#ffffff40",
                paddingTop: 5,
                paddingBottom: 5,
      ...
      >
        <Box className="lg:w-5/12 sm:w-7/12 w-full" sx={styleAddCardPopup}>
      ...
      >
        <Alert
          ...
          severity={
            snackMessage && snackMessage.status === true ? "success" : "error"
          } // "error"
          sx={{
            width: "auto",
            fontWeight: "700",
