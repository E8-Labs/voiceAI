    ...
    return (
        <div className='h-screen w-full px-4 pb-4' style={{ backgroundColor: "#ffffff40", overflow: 'auto', scrollbarWidth: 0, }}>
            ...
            <div className='w-full p-3 rounded-xl mt-6'
                ...
                <br /> <div style={{ fontWeight: "bold", fontSize: 18 }}> 2. Eligibility: </div><br />
                ...
                <br /> <div style={{ fontWeight: "bold", fontSize: 18 }}> 3. Account Registration: </div><br />
                ...
                <br /> <div style={{ fontWeight: "bold", fontSize: 18 }}> 4. Use of the Service: </div><br />
                ...
                <br /> <div style={{ fontWeight: "bold", fontSize: 18 }}> 5. AI Twin Customization: </div><br />
                ...
                <br /> <div style={{ fontWeight: "bold", fontSize: 18 }}> 6. Caller Information Collection: </div><br />
                ...
                <br /> <div style={{ fontWeight: "bold", fontSize: 18 }}> 7. Disclaimer of AI Twin Content: </div><br />
                ...
                <br /> <div style={{ fontWeight: "bold", fontSize: 18 }}> 8. Pricing and Payment: </div><br />
                ...
                <br /> <div style={{ fontWeight: "bold", fontSize: 18 }}> 9. Data Security and Privacy: </div><br />
                ...
                <br /> <div style={{ fontWeight: "bold", fontSize: 18 }}> 10. Intellectual Property: </div><br />
                ...
                <br /> <div style={{ fontWeight: "bold", fontSize: 18 }}> 11. Limitation of Liability: </div><br />
                ...
                <br /> <div style={{ fontWeight: "bold", fontSize: 18 }}> 12. Indemnification: </div><br />
                ...
                <br /> <div style={{ fontWeight: "bold", fontSize: 18 }}> 13. Termination: </div><br />
                ...
                <br /> <div style={{ fontWeight: "bold", fontSize: 18 }}> 14. Changes to the Terms: </div><br />
                ...
                <br /> <div style={{ fontWeight: "bold", fontSize: 18 }}> 15. Governing Law: </div><br />
                ...
                <br /> <div style={{ fontWeight: "bold", fontSize: 18 }}> 16. Dispute Resolution: </div><br />
                ...
                <br /> <div style={{ fontWeight: "bold", fontSize: 18 }}> 17. Contact Information: </div><br />
