...
export default function ScriptAnimation2({ onChangeIndex }) {
  ...
  useEffect(() => {
    const allQuestionFilled = inputs.every(
          ...
          >
            ...
            >
              <div className="w-full flex justify-center overflow-none">
                <div className="w-11/12 sm:w-full">
                  <div style={{ backgroundColor: "", height: 24 }}></div>
                  {/* <CallerInfo /> */}
                  ...
                  <div className="text-sm text-gray-400 mt-2 w-full sm:w-9/12">
                    Your AI will qualify prospects and give you a better
              ...
              <div className="w-full flex justify-center">
                <div className="w-11/12 sm:w-full">
                  ...
                  >
                    ...
                    {inputRows.every(
                      (row) => row.productAmount && row.productName
                    ) ? (
                      <div className="w-full sm:w-9/12">
                        <button
                          onClick={handleContinue}
        ...
        {currentIndex === 4 && (
          ...
          >
            ...
            >
              <div className="w-full flex justify-center">
                <div
                  className="w-11/12 sm:w-full" //style={{ paddingBottom: 30 }}
                >
                  <div>
                    <button onClick={handleBack}>
                      <Image
            ...
            >
              <div className="w-full flex justify-center">
                <div className="w-11/12 sm:w-full">
                  ...
                  <div>
                    <SetPrice
                      buildScriptLoader={buildScriptLoader}
                      handleContinue={handleBuildScript}
                    />
                  </div>
                  {/* {
                                            buildScriptErr &&
                  ...
                  >
                    ...
                    >
                      <button
                        ...
                        className="w-full py-3 text-white bg-purple"
                    ...
                    >
                      Your account will be under review. We do this to ensure we
                      CreatorX is a safe and authentic platform for creators.
                      You'll need to complete this step for our team to review
                      your creator account. We'll be in touch in 24hrs.
                    </div>
                  </div>
                </div>
                <div className="w-6/12">
              ...
              <div className="w-full flex justify-center">
                <div className="w-full flex flex-col justify-center items-center ">
                  <div className="w-full">
                    ...
                    <Image
                      className="mt-5"
                      src={"/assets/redNotificationIcon.png"}
                      width={30}
                      height={30}
                    />
                    ...
                    >
                      Get notified when Lorem ipsum dolor sit amet,
