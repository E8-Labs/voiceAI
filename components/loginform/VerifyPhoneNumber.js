...
const VerifyPhoneNumber = ({
  ...
  const [verificationIdConfirm, setVerificationIdConfirm] =
            ...
            if (response.data.status === true) {
              ...
              if (localAssistantData) {
                ...
                if (AssistantData.assitant.allowTrial === true) {
                  console.log(
                    "trial ststus is",
                    AssistantData.assitant.allowTrial
                  );
              ...
              if (response.data.data.user.role == "admin") {
                ...
                if (LocalData) {
                  ...
                  const localAssistantData =
                    localStorage.getItem("assistantData");
                  if (localAssistantData) {
                    const AssistantData = JSON.parse(localAssistantData);
                    const callStatus = {
                      callStatus: true,
  ...
  return (
    <div>
      ...
      <div style={{ fontSize: 24, fontWeight: "600" }}>Verify Phone Number</div>
      ...
      >
        ...
        {signinVerificationNumber?.slice(-4)}{" "}
        {userLoginDetails?.phone.slice(-4)}
      </div>
          ...
          <div>
            {verifyLoader ? (
              ...
              <button
                ...
                className="bg-purple px-8 text-white py-2"
                style={{
                  fontWeight: "400",
                  fontSize: 15,
                  borderRadius: "50px",
